...
/datum/uplink_item/jobspecific
	...
	cant_discount = TRUE
	excludefrom = list(UPLINK_TYPE_NUCLEAR, UPLINK_TYPE_NUCLEAR_LONE, UPLINK_TYPE_SST) // Stops the job specific category appearing for nukies
...
/datum/uplink_item/support/reinforcement
	...
	cost = 20
	excludefrom = list(UPLINK_TYPE_NUCLEAR_LONE)
	refundable = TRUE
	cant_discount = TRUE
...
/datum/uplink_item/stealthy_tools/chamsechud
	name = "Chameleon Peacemakers HUD"
	desc = "A stolen Peacemakers HUD with Syndicate chameleon technology implemented into it. Similarly to a chameleon jumpsuit, the HUD can be morphed into various other eyewear, while retaining the HUD qualities when worn."
	reference = "CHHUD"
