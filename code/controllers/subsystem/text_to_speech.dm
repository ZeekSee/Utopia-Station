...
SUBSYSTEM_DEF(tts)
	...
	var/static/list/tts_job_replacements = list(
		...
		"peacemakers leader" = "Лидер миротворцев",
		"warden" = "Смотритель",
		"detective" = "Детектив",
		"forensic technician" = "Криминалист",
		"peacemaker" = "Миротворец",
		"peacemaker cadet" = "Кадет миротворцев",
		"peacemakers Assistant" = "Ассистент миротворцев",
		"peacemakers Graduate" = "Выпускник кадетской академии",
		"brig physician" = "Врач брига",
		"peacemaker pod pilot" = "Пилот пода миротворцев",
		"ai" = "И И",
		"cyborg" = "Киборг",
		"robot" = "Робот",
		"captain" = "Капитан",
