...
/datum/game_mode/shadowling
	...
	protected_jobs = list("Peacemaker", "Peacemaker Cadet", "Warden", "Detective", "Peacemaker's Leader", "Head of Personnel", "Captain", "Blueshield", "Nanotrasen Representative", "Security Pod Pilot", "Magistrate", "Brig Physician", "Internal Affairs Agent", "Nanotrasen Navy Officer", "Nanotrasen Navy Field Officer", "Special Operations Officer", "Supreme Commander", "Syndicate Officer")
