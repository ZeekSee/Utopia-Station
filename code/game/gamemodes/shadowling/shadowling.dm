...
/datum/game_mode/shadowling
	...
	protected_jobs = list("Peacemaker", "Peacemaker Cadet", "Warden", "Detective", "Peacemakers Leader", "Head of Personnel", "Captain", "Blueshield", "Nanotrasen Representative", "Peacemaker Pod Pilot", "Magistrate", "Brig Physician", "Internal Affairs Agent", "Nanotrasen Navy Officer", "Nanotrasen Navy Field Officer", "Special Operations Officer", "Supreme Commander", "Syndicate Officer")
