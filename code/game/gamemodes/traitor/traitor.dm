...
/datum/game_mode/traitor
	...
	protected_jobs = list("Peacemaker", "Peacemaker Cadet", "Warden", "Detective", "Peacemaker's Leader", "Captain", "Blueshield", "Nanotrasen Representative", "Security Pod Pilot", "Magistrate", "Internal Affairs Agent", "Brig Physician", "Nanotrasen Navy Officer", "Nanotrasen Navy Field Officer", "Special Operations Officer", "Supreme Commander", "Syndicate Officer")
	required_players = 0
	required_enemies = 1
