...
/datum/game_mode/thief
	...
	protected_jobs = list("Peacemaker Cadet", "Peacemaker", "Warden", "Detective", "Peacemakers Leader", "Captain", "Blueshield", "Nanotrasen Representative", "Security Pod Pilot", "Magistrate", "Brig Physician", "Internal Affairs Agent", "Nanotrasen Navy Officer", "Nanotrasen Navy Field Officer", "Special Operations Officer", "Supreme Commander", "Syndicate Officer")
