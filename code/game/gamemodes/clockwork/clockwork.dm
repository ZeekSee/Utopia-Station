...
/datum/game_mode/clockwork
	...
	restricted_jobs = list("Chaplain", "AI", "Cyborg", "Internal Affairs Agent", "Peacemaker", "Peacemaker Cadet", "Warden", "Detective", "Peacemaker Pod Pilot", "Peacemaker's Leader", "Captain", "Head of Personnel", "Blueshield", "Nanotrasen Representative", "Magistrate", "Brig Physician", "Nanotrasen Navy Officer", "Nanotrasen Navy Field Officer", "Special Operations Officer", "Supreme Commander", "Syndicate Officer")
	protected_jobs = list()
	required_players = 30
	required_enemies = 3
