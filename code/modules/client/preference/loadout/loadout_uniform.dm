...
/datum/gear/uniform/skirt/job/warden
	...
	allowed_roles = list("Peacemaker's Leader", "Warden")
...
/datum/gear/uniform/sec/secorporate
	...
	allowed_roles = list("Peacemaker's Leader", "Warden", "Security Officer", "Security Cadet", "Security Pod Pilot")
...
/datum/gear/uniform/sec/casual
	...
	allowed_roles = list("Peacemaker's Leader", "Warden", "Security Officer", "Security Cadet", "Detective", "Security Pod Pilot")
